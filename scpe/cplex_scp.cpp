 ...
 *  Pasta scpe: instâncias OR-Library scpe* (50 elementos, 500 conjuntos)
 *
 ...
 *      número de conjuntos que cobrem o elemento
 *      índices dos conjuntos que cobrem esse elemento (1-based)
 *
 *  Compilar (exemplo):
 ...
 *
 *  Executar:
 *    ./cplex_scp instancias/scpe1.txt
 * ============================================================
 */
...
int main(int argc, char* argv[]) {
    ...
    // Timer inicia apos a leitura, contando construcao do modelo + solve.
    // Isso deixa a comparacao com o DLX mais honesta em instancias pequenas.
