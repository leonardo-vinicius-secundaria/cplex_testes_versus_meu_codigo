 ...
 * matriz) vem da versao estavel. Esta variante preserva o Iterated Greedy,
 * o dual e o fixing inicial da V2, mas executa uma unica arvore de B&B.
 */
...
// ============================================================
// searchV2() — V2 com uma unica execucao da arvore, sem restart.
// ============================================================
...
int main(int argc, char* argv[])
{
    ...
    cout << "\nInstancia carregada — DLX V2 sem restart!\n";
    ...
    cout << "Modo                     : Set Cover / DLX V2 sem restart\n\n";
