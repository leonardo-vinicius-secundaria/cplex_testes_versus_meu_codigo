/*
 * DLX V2 sem restart + ordenacao de candidatos orientada a prova.
 *
...
long long proofOrderedCandidates = 0;
...
void searchV2(int k, int MAX_K, int custoAtual)
{
    ...
    proofOrderedCandidates += fimCandidatos - inicioCandidatos;
    sort(
        arenaCandidatos + inicioCandidatos,
        arenaCandidatos + fimCandidatos,
        [](const Candidato& a, const Candidato& b)
        {
            // Com um incumbente inicial forte, visita primeiro os filhos mais
            // proximos do corte. Os que ja falham no bound sao proibidos antes
            // dos filhos sobreviventes e deixam de reaparecer neles.
            if (a.limiteFilho != b.limiteFilho)
                return a.limiteFilho > b.limiteFilho;
            if (a.custoReduzido != b.custoReduzido)
                return a.custoReduzido > b.custoReduzido;
...
int main(int argc, char* argv[])
{
    ...
    cout << "\nInstancia carregada — DLX V2 sem restart + ordenacao de prova!\n";
    ...
    cout << "Modo                     : Set Cover / DLX V2 sem restart + ordenacao de prova\n\n";
    ...
    cout << "  Candidatos reordenados  : " << proofOrderedCandidates << "\n";
